...
<p>Weather Description:<br><img src="http://openweathermap.org/img/wn/{r.json().get("weather")[0].get("icon")}@2x.png" height="30" width="30">{r.json().get("weather")[0].get("main")} -- {r.json().get("weather")[0].get("description")}</p>
